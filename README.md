...
When connectivity appears to be offline, IsConnected can show a pulsing colored warning overlay around the selected screen area, edge, or corner, making network problems visible without opening the tray menu.
